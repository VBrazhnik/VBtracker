...
public class MonthFragmentAdapter extends RecyclerView.Adapter<MonthFragmentAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.date_picker_month_cell, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            dateText = view.findViewById(R.id.date_picker_month_cell_date);
            cellLayout = view.findViewById(R.id.date_picker_month_cell);
