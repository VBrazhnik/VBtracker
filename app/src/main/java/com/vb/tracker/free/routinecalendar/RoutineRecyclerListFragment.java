...
public class RoutineRecyclerListFragment extends Fragment {

    private CalendarDate date;
    private RoutineCalendar calendar;

    public RoutineRecyclerListFragment() {
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        RoutineRecyclerListAdapter adapter = new RoutineRecyclerListAdapter(RoutineRecyclerListFragment.this, calendar);
